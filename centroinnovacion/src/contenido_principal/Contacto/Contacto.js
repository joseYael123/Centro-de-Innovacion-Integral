        ...
        <Container fluid className='contCont d-flex justify-content-center align-items-center my-5'>
            <Form className='rounded shadow-lg p-5 w-75 bg-white' onSubmit={handleSubmit} style={{ maxWidth: "800px" }}>
                ...
                <Form.Group className='mb-4'>
                    ...
                    <Form.Control type="email" placeholder='ejemplo@gmail.com' className="p-3 bg-light border-0 shadow-sm input-verde"/>
                </Form.Group>
                ...
                <div className='d-flex flex-column flex-md-row w-100 gap-3 mb-4'>
                    <Form.Group className='w-100'>
                        ...
                        <Form.Control type="text" placeholder='Tu nombre' className="p-3 bg-light border-0 shadow-sm input-verde" />
                    </Form.Group>

                    <Form.Group className='w-100'>
                        <Form.Label className="fw-bold small text-secondary">Apellidos</Form.Label>
                        <Form.Control type="text" placeholder='Tus apellidos' className="p-3 bg-light border-0 shadow-sm input-verde" />
                    </Form.Group>
                </div>
